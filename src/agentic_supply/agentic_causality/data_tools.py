...
class DataStorer(CodedTool):
    ...
    async def async_invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Any:
        ...
        sly_data["data_name"] = data_name
        logger.info(f"data_name stored in sly_data : {sly_data['data_name']}")
        return "data_name correctly stored in sly_data"
